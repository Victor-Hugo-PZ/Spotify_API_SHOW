...
class SpotifyApp(ctk.CTk):
    ...
    def destacar_botao_ativo(self, botao_clicado):
        self.btn_artistas.configure(fg_color="transparent", text_color="#FFFFFF")
        self.btn_musicas.configure(fg_color="transparent", text_color="#FFFFFF")
        self.btn_recentes.configure(fg_color="transparent", text_color="#FFFFFF")
        botao_clicado.configure(fg_color=self.accent_color, text_color="#000000")
    ...
    def criar_card(self, numero, titulo, subtitulo, url_imagem=None, estatistica=None):
        ...
        lbl_titulo = ctk.CTkLabel(text_frame, text=titulo, font=ctk.CTkFont(size=15, weight="bold"), anchor="w")
